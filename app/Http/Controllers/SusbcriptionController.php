...
class SusbcriptionController extends Controller
{
    ...
    {
        return view('owner.susbcriptions');
    }
    ...
    public function cancel(Request $request)
    {
        try {
            ...
            $openpayService = new OpenpayService($openpay, $user);

            $result = $openpayService->cancelSubscription(
    ...
    public function getCurrentSubscriptions(Request $request)
    {
