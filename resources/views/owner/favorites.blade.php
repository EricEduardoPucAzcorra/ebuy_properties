...
<div id="mypropiertes">
    <div class="container-fluid py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">{{ auto_trans('Favoritos') }}</h1>
                <p class="text-muted mb-0">{{ auto_trans('Gestionar mis propiedades favoritas.')}}</p>
            </div>
        ...
        @include('owner.components.list_properties_favorites')
