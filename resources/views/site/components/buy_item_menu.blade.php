    ...
    <div class="ebuy-mega-wrapper">
        <div class="mega-card">
            <div class="mega-sidebar">
                <div class="sidebar-item active" data-target="pane-fixed-house">
                ...
                <div class="sidebar-item" data-target="pane-fixed-dep">
            ...
            <div class="mega-content">
                ...
                <div class="mega-pane active" id="pane-fixed-house">
                        ...
                        <div class="mega-col">
                            ...
                            <ul class="mega-list-styled">
                                @forelse($featuredCities as $city)
                                    <li>
                                        <a href="{{ route('properties', array_merge(['operation' => $type_operationbuy->id, 'type'=> $property_typebuy->id, 'location_type'=>$city->type, 'location_id'=>$city->id])) }}">
                        ...
                        <div class="mega-col">
                            ...
                            <ul class="mega-list-styled">
                                @foreach($featuredStates as $st)
                                    <li>
                                        <a href="{{ route('properties', array_merge(['operation' => $type_operationbuy->id, 'type'=> $property_typebuy->id, 'location_type'=>'state', 'location_id'=>$st->id])) }}">
                ...
                <div class="mega-pane" id="pane-fixed-dep">
                    <div class="mega-grid-layout">
                        <div class="mega-col">
                            ...
                            <ul class="mega-list-styled">
                                @forelse($featuredCities as $city)
                                    <li>
                                        <a href="{{ route('properties', array_merge(['operation' => $type_operationdep->id, 'type'=> $property_typedep->id, 'location_type'=>$city->type, 'location_id'=>$city->id])) }}">
                                            <i class="bi bi-geo-alt me-1 text-muted"></i> {{ $city->cityname }}
                                        </a>
                                    </li>
                                @empty
                        ...
                        <div class="mega-col">
                            ...
                            <ul class="mega-list-styled">
                                @foreach($featuredStates as $st)
                                    <li>
                                        <a href="{{ route('properties', array_merge(['operation' => $type_operationdep->id, 'type'=> $property_typedep->id, 'location_type'=>'state', 'location_id'=>$st->id])) }}">
                                            <strong>{{ $st->statename }}</strong>
                                        </a>
                                    </li>
                                @endforeach
